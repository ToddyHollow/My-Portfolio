...
export const constructionProjects = [
  {
    ...
    role: "HVAC Field Installer -- Journeyman Pookey-Queen",
    value: "$47M",
  ...
  },
  {
    ...
    description: [
      ...
      "Produced detailed mechanical room drawings including chiller and cooling tower piping.",
      "Drafted large-diameter flanged assemblies and valve configurations.",
    ],
  },
  {
